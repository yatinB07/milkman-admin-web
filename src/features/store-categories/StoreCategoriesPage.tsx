import { Edit3, ListTree, Plus, Trash2 } from 'lucide-react'
...
export function StoreCategoriesPage() {
  ...
  const saveCategory = useMutation({
    ...
    onError: (error) => {
      const errors = readFieldErrors<keyof StoreCategoryFormErrors>(error, ['store_id', 'title'])

      if (errors.store_id || errors.title) {
